...
#define DRIVE_CONTROLLER_1_CHANNEL 3
...
#define GRAB_ARM_SPEED .2
#define GRAB_ARM_CHANNEL 4

#define GRAB_ARM_LIMIT_SWITCH_IN_CHANNEL 2
#define GRAB_ARM_LIMIT_SWITCH_OUT_CHANNEL 3

//Grabey Wheels
#define GRAB_WHEEL_CONTROLLER_A 2
#define GRAB_WHEEL_CONTROLLER_B 3
#define GRAB_WHEEL_SPEED .2
